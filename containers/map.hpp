...
/*   Updated: 2021/03/24 05:34:11 by lemarabe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
    ...
    class Map {
        ...
        public :
            ...
            iterator        end() { return iterator(myMap.getFarRight()); }
            const_iterator  begin() const { return const_iterator(myMap.getFarLeft()); }
            const_iterator  end() const { return const_iterator(myMap.getFarRight()); }
    ...
    std::ostream &operator<<(std::ostream &out, Map<Key,T,Compare,Alloc> const &map) {
        ...
        out << "\t>> MAP [" << size << "]\t= { ";
        for (typename Map<Key,T,Compare,Alloc>::iterator it = map.begin(); it != map.end(); it++)
        {
